...
```bash
git remote add encore encore://badminton-team-management-r3ii
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/badminton-team-management-r3ii/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/badminton-team-management-r3ii/settings/integrations/github)
